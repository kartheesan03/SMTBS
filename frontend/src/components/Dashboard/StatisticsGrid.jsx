...
import { Users, Calendar, Clock, Box, ShoppingCart, IndianRupee, Target, CheckSquare } from 'lucide-react';
...
const StatisticsGrid = ({ stats, attendance }) => {
  ...
  return (
    <div className="dash-statistics-grid">
      ...
      <StatBox title="Today's Revenue" value={formatCurrency(stats.todaysRevenue || 0)} icon={IndianRupee} colorClass="bg-green" highlight />
