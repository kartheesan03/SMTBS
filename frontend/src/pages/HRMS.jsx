...
const HRMS = () => {
  ...
  const filteredEmployees = employees.filter((emp) => {
    ...
    if (statusFilter === "On Leave") matchesStatus = false;
  ...
  const leavePercent =
    totalEmployees > 0 ? Math.round((leaveCount / totalEmployees) * 100) : 0;
      ...
      <div className="rd-content">
        ...
        <StatsGrid>
          ...
          <StatsCard
            ...
            colorTheme="purple"
            icon={Users}
            trendValue="No inactive records"
            trendPositive={true}
          />
        </StatsGrid>
        {/* Table Section */}
                ...
                {filteredEmployees.length === 0 ? (
                  ...
                  filteredEmployees.map((emp) => (
                    <tr
                      key={emp.id || emp._id}
                      onClick={() =>
                        navigate(`/employees/${emp.id || emp._id}`)
                      }
                    ...
                    >
                      <td data-label="Employee">
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {emp.employeeId || `EMP-${emp.id || emp._id}`}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td style={{ color: "#64748b" }} data-label="Phone">
                        {emp.phone ||
                        ...
                        {!isEmployeeOrSales && (
                          <>
                            <button
                              className="rd-btn-compact"
                              onClick={() =>
                                navigate(`/employees/${emp.id || emp._id}/edit`)
                              }
                              style={{
                                background: "none",
                                border: "none",
