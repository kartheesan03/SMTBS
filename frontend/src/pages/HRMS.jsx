    ...
    return (
        <div className="module-container">
            ...
            <style jsx="true">{`
                ...
                .employee-card { text-align: center; display: flex; flex-direction: column; align-items: center; background: var(--bg-surface); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg, 16px); padding: 24px; box-shadow: var(--shadow-sm); transition: transform 0.2s, box-shadow 0.2s; }
                .employee-card:hover { transform: translateY(-4px); box-shadow: var(--shadow-md); }
                
                .emp-avatar { width: 64px; height: 64px; background: var(--primary-light); color: var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 24px; font-weight: 800; margin-bottom: 16px; border: 2px solid var(--bg-app); box-shadow: 0 4px 12px color-mix(in srgb, var(--primary) 20%, transparent); }
                .employee-card h3 { font-size: 18px; font-weight: 800; margin: 0 0 4px 0; color: var(--text-heading); }
                .designation { color: var(--text-muted); font-size: 14px; margin: 0 0 20px 0; font-weight: 600; }
                
                .emp-details { width: 100%; text-align: left; margin-bottom: 20px; border-top: 1px dashed var(--border-subtle); padding-top: 15px; }
                ...
                .emp-footer { width: 100%; display: flex; justify-content: space-between; align-items: center; padding-top: 16px; border-top: 1px solid var(--border-subtle); }
                .emp-footer-actions { display: flex; align-items: center; gap: 8px; }
                .dept-badge { background: var(--primary-light); color: var(--primary); padding: 6px 12px; border-radius: 20px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; }
                
                .action-btn-sm { background: var(--bg-app); border: 1px solid var(--border-subtle); color: var(--text-heading); padding: 6px 14px; border-radius: 8px; font-size: 12px; font-weight: 600; transition: 0.2s; cursor: pointer; }
                .action-btn-sm:hover { background: var(--bg-hover); border-color: var(--primary); color: var(--primary); }
                
                .btn-delete { background: var(--danger-bg); border: 1px solid transparent; color: var(--danger); padding: 10px 20px; border-radius: 8px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s; font-size: 14px; }
                ...
                .delete-confirm-icon { width: 72px; height: 72px; background: var(--danger-bg); color: var(--danger); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px; }
                .delete-confirm-text { color: var(--text-muted); font-size: 15px; line-height: 1.6; margin-bottom: 24px; }
                ...
                .modal-content { width: 100%; max-width: 600px; padding: 32px; position: relative; text-align: left; max-height: 90vh; overflow-y: auto; background: var(--bg-surface); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg, 16px); color: var(--text-heading); box-shadow: var(--shadow-lg); }
                .modal-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 28px; border-bottom: 1px solid var(--border-subtle); padding-bottom: 16px; }
                .modal-header h2 { color: var(--text-heading); font-size: 20px; font-weight: 800; margin: 0; }
                ...
                .form-group input, .form-group select { padding: 12px 16px; background: var(--bg-app); border: 1px solid var(--border-subtle); border-radius: 8px; color: var(--text-heading); width: 100%; font-size: 14px; outline: none; transition: border-color 0.2s; }
                .form-group input:focus, .form-group select:focus { border-color: var(--primary); box-shadow: 0 0 0 3px var(--primary-light); background: var(--bg-surface); }
                ...
                .btn-cancel { background: var(--bg-app); color: var(--text-muted); border: 1px solid var(--border-subtle); padding: 12px 24px; border-radius: 8px; font-weight: 700; font-size: 14px; cursor: pointer; transition: 0.2s; }
                .btn-cancel:hover { background: var(--bg-hover); border-color: var(--border-strong); color: var(--text-heading); }
                
                .animate-pop { animation: pop 0.3s cubic-bezier(0.34, 1.56, 0.64, 1); }
                @keyframes pop { from { opacity: 0; transform: scale(0.9); } to { opacity: 1; transform: scale(1); } }
                
                /* Profile View Styles */
                .profile-view { background: var(--bg-app); border-radius: 12px; padding: 24px; border: 1px solid var(--border-subtle); }
                .profile-top { display: flex; align-items: center; gap: 24px; margin-bottom: 24px; border-bottom: 1px dashed var(--border-subtle); padding-bottom: 24px; }
                ...
                .profile-titles h3 { font-size: 22px; font-weight: 800; margin: 0 0 6px 0; color: var(--text-heading); }
                ...
                .profile-item p { font-size: 15px; color: var(--text-heading); font-weight: 600; margin: 0; }
