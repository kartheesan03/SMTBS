...
const MaterialDetails = ({ embeddedId }) => {
  ...
  useEffect(() => {
    const fetchMaterialData = async () => {
      try {
        ...
        const timelineRes = await API.get(`/materials/${id}/timeline`).catch(
          (e) => ({ data: [] })
        );
        ...
        const errMsg =
          err.response?.data?.message || "Failed to load material details.";
        toast.error(errMsg);
        setError(errMsg);
      } finally {
        setLoading(false);
  ...
  const availableStock = Math.max(
    0,
    material.quantity - (material.reservedQuantity || 0)
  );
  ...
  const isLive =
    material.locationUpdatedAt &&
    Date.now() - new Date(material.locationUpdatedAt).getTime() < 30 * 60000;
  let locationAge = "Unknown";
  if (material.locationUpdatedAt) {
    const mins = Math.floor(
      (Date.now() - new Date(material.locationUpdatedAt).getTime()) / 60000
    );
      ...
      {activeTab === "details" ? (
          ...
          <div style={{ flex: "1 1 350px", minWidth: 0 }}>
            ...
            >
              ...
              >
                ...
                {(() => {
                  ...
                  if (cat.includes("electrical"))
                    return <Target size={64} color="#3b82f6" opacity={0.2} />;
                  if (cat.includes("metal") || cat.includes("steel"))
                    return <Layers size={64} color="#64748b" opacity={0.2} />;
                  if (cat.includes("wood") || cat.includes("timber"))
                    return <Box size={64} color="#d97706" opacity={0.2} />;
                  if (cat.includes("cement"))
                    return <Box size={64} color="#94a3b8" opacity={0.2} />;
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  {material.tags &&
                    material.tags.map((t, idx) => (
                      <span key={idx} className="pill pill-blue">
                        {t}
                      </span>
                    ))}
                </div>
                ...
                <div
                  style={{ fontSize: 14, color: "#64748b", marginBottom: 20 }}
                >
                  {material.category} &middot; SKU:{" "}
                  {material.sku || `MAT-${material.id}`}
                </div>
                <div style={{ display: "flex", gap: 24 }}>
                  <div>
                    ...
                    >
                      <User size={14} /> {material.source || "Bulk purchase"}
                    </div>
                  </div>
                  <div>
                    <div
            ...
            <div className="card">
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                >
                  ...
                  >
                    <Layers size={14} /> Stock Level (Avail/Total)
                  </div>
                  <div
                    style={{ fontSize: 13, fontWeight: 700, color: "#0f172a" }}
                  >
                    {availableStock} / {material.quantity} {material.unit}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  <div
                    style={{
                      width: `${Math.min(
                        100,
                        (material.quantity / (material.maxCapacity || 1000)) *
                          100
                      )}%`,
                      height: "100%",
                      background: stockColor,
              ...
              >
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 16,
                      color: specs?.Thickness ? "#0f172a" : "#94a3b8",
                      fontWeight: specs?.Thickness ? 700 : 500,
                      fontStyle: specs?.Thickness ? "normal" : "italic",
                    }}
                  >
                    {specs?.Thickness || "N/A"}
                  </div>
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 16,
                      color: specs?.Grade ? "#0f172a" : "#94a3b8",
                      fontWeight: specs?.Grade ? 700 : 500,
                      fontStyle: specs?.Grade ? "normal" : "italic",
                    }}
                  >
                    {specs?.Grade || "N/A"}
                  </div>
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 16,
                      color: specs?.Length ? "#0f172a" : "#94a3b8",
                      fontWeight: specs?.Length ? 700 : 500,
                      fontStyle: specs?.Length ? "normal" : "italic",
                    }}
                  >
                    {specs?.Length || "N/A"}
                  </div>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <Activity size={14} />{" "}
                    {timeline.length > 0 ? timeline[0].action : "N/A"}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                  ...
                  <div>
                    ...
                    >
                      {material.warehouse || "Unassigned"}
                      {material.rack ? `, Rack ${material.rack}` : ""}
                    </div>
                    <div
                      style={{
                        fontSize: 12,
                    ...
                    >
                      {material.shelf ? `Shelf ${material.shelf}` : "N/A"}
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="card">
              ...
              >
                ...
                <button
                  onClick={() =>
                    toast.success("Report submitted for administration review.")
                  }
                  style={{
                    padding: "6px 12px",
                    background: "#fff",
              ...
              >
                Last audit:{" "}
                {material.lastAuditDate
                  ? new Date(material.lastAuditDate).toLocaleDateString(
                      "en-GB",
              ...
              >
                {material.auditNotes ||
                  "No recent audit notes available for this material."}
              </p>
            </div>
            {/* Shelf Photos */}
            <div className="card">
              ...
              >
                {(() => {
                  const validImages = (material.images || []).filter(
                    (url) =>
                      url &&
                    ...
                    return (
                      <>
                        ...
                        {validImages.length > 3 ? (
                          ...
                          Array.from({ length: 4 - validImages.length }).map(
                            (_, idx) => (
                              <div
                                key={`empty-${idx}`}
                                style={{
            ...
            <div className="card">
              ...
              >
                ...
                >
                  ...
                  >
                    <Calendar size={14} /> Mill TC date
                  </div>
                  <div
                    style={{ fontSize: 12, fontWeight: 700, color: "#0f172a" }}
                  >
                    {material.compliance?.tcDate || "N/A"}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  <div
                    ...
                    style={{ margin: 0, fontSize: 12 }}
                  >
                    <Calendar size={14} /> TC expiry
                  </div>
                  <div
                    style={{ fontSize: 12, fontWeight: 700, color: "#0f172a" }}
                  >
                    {material.compliance?.tcExpiry || "N/A"}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  <div
                    ...
                    style={{ margin: 0, fontSize: 12 }}
                  >
                    <CheckCircle size={14} /> QC status
                  </div>
                  <div
                    style={{ fontSize: 12, fontWeight: 700, color: "#16a34a" }}
                  >
                    {material.compliance?.qcStatus || "Pending"}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  <div
                    ...
                    style={{ margin: 0, fontSize: 12 }}
                  >
                    <Hash size={14} /> Batch no.
                  </div>
                  <div
                    style={{ fontSize: 12, fontWeight: 700, color: "#0f172a" }}
                  >
                    {material.batchNo || "N/A"}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 14, color: "#64748b" }}>
                Shipment ID: {material.activeShipmentId || "N/A"}
              </div>
            </div>
            <div style={{ display: "flex", gap: 32 }}>
              ...
              <div style={{ textAlign: "center" }}>
                <div
                  style={{ fontSize: 24, fontWeight: 800, color: "#16a34a" }}
                >
                  {material.arrivingSoonCount || 0}
                </div>
                <div
                  style={{
                    fontSize: 12,
              ...
              <div style={{ textAlign: "center" }}>
                <div
                  style={{ fontSize: 24, fontWeight: 800, color: "#dc2626" }}
                >
                  {material.delayedCount || 0}
                </div>
                <div
                  style={{
                    fontSize: 12,
            ...
            >
              ...
              >
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  >
                    {material.deliveryDestination || "Destination"}
                  </div>
          ...
          <div className="card">
            ...
            >
              <FileText size={18} /> Live Activity Feed
            </h3>
            <div
              style={{
                display: "flex",
                ...
                timeline.slice(0, 3).map((log, i) => (
                  <div key={i} style={{ position: "relative" }}>
                    ...
                    <div style={{ fontSize: 13, color: "#475569" }}>
                      {log.description || "System log recorded."}
                    </div>
                    <div
                      style={{
                        fontSize: 12,
