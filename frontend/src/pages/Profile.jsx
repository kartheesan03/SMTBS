...
const Profile = () => {
  ...
  const handleDeleteAccount = async () => {
    if (deleteConfirmation !== "DELETE")
      return toast.success("Please type DELETE to confirm.");
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "Could not update employee record, proceeding to auth profile update:",
      ...
      <div className="premium-profile-banner">
        ...
        <div className="premium-banner-details">
          ...
          <span className="last-login-banner">
            {displayEmail} &bull; Last Login: {formatLoginTime(user?.loginTime)}
          </span>
        </div>
      </div>
      {/* Main Grid */}
          ...
          {user?.role !== "Vendor" && (
            <div className="ui-card mb-24">
              ...
              <div className="details-list">
                ...
                <div className="detail-row">
                  <div className="detail-label">⏱️ Employment Type</div>
