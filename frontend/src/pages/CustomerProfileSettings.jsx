...
const CustomerProfileSettings = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (!payload.company || payload.company === "Pending Details")
        payload.company = "Individual Customer";
      ...
      if (
        ...
        const authRes = await API.put("/auth/profile", {
          name: formData.name,
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Password Update Failed. Please check current password if required."
      );
    }
  };
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message ||
          "Error deleting account. Please check your password."
      );
      setIsDeleting(false);
    }
  };
      ...
      <div className="premium-profile-banner" style={{ marginBottom: "24px" }}>
        <div className="premium-banner-avatar-wrapper">
          <div className="premium-banner-avatar">
            {formData.picture && !imgError ? (
              ...
              <span className="premium-banner-avatar-initial">{initials}</span>
            )}
          </div>
        ...
        <div className="premium-banner-details">
          <div className="user-name-row-banner">
            <span className="primary-title-banner">
              {formData.name || user?.name}
            </span>
          ...
          <div className="banner-badges-premium">
            ...
            <span
              className="premium-badge-banner secondary-badge"
              style={{ display: "flex", alignItems: "center" }}
            >
              <Building2 size={12} style={{ marginRight: "4px" }} />{" "}
              {formData.company || "Individual Customer"}
            </span>
            <span
              className="premium-badge-banner secondary-badge"
              style={{ display: "flex", alignItems: "center" }}
            >
              <Calendar size={12} style={{ marginRight: "4px" }} /> Joined:{" "}
            ...
            {!isEditing ? (
              <div className="profile-read-only">
                ...
                <div className="info-row">
                  ...
                  <span>{formData.company || "Individual Customer"}</span>
                </div>
                <div className="info-row">
                ...
                <div className="info-row">
                  ...
                  <span>{formData.gstNumber || "Not provided"}</span>
                </div>
                <div className="info-row">
                  <label>Address</label>
        ...
        <div className="profile-col-right">
          <div className="premium-card">
            ...
            <form className="ui-form" onSubmit={handlePasswordUpdate}>
              ...
              <button type="submit" className="btn-outline-purple">
                Update Password
              </button>
            </form>
          </div>
      ...
      <div className="danger-zone-card" style={{ marginTop: "24px" }}>
        ...
        <div className="danger-content">
          <div className="danger-text">
            ...
            <p>
              ⚠ This action cannot be undone. All customer profile data, orders,
              addresses, support tickets, and account information will be
              permanently removed.
            </p>
          </div>
          <button
