      ...
      <nav className={`landing-nav ${scrolled ? "scrolled" : ""}`}>
        ...
        >
          ...
          <div className="nav-links">
            <a
              href="#hero"
              className={activeSection === "hero" ? "active-nav-link" : ""}
              onClick={(e) => {
                e.preventDefault();
            ...
            <a
              href="#stats"
              className={activeSection === "stats" ? "active-nav-link" : ""}
              onClick={(e) => {
                e.preventDefault();
            ...
            <a
              href="#features"
              className={activeSection === "features" ? "active-nav-link" : ""}
              onClick={(e) => {
                e.preventDefault();
            ...
            <a
              href="#ai"
              className={activeSection === "ai" ? "active-nav-link" : ""}
              onClick={(e) => {
                e.preventDefault();
                scrollToSection("ai");
              }}
      ...
      <section className="landing-section features-section" id="features">
        <div className="global-container">
          <div className="section-header">
            ...
            <p>
              A complete suite of tools designed to streamline your entire
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Track stock levels across multiple locations in real-time with
            ...
            <div className="feature-card">
              ...
              <p>
                Optimize warehouse layouts, routing, and bin locations for
                maximum efficiency.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                Automate PO generation based on dynamic stock thresholds and
                vendor lead times.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                Maintain comprehensive vendor catalogs, performance metrics, and
      ...
      <section className="landing-section workflow-section" id="workflow">
        <div className="global-container">
          <div className="section-header">
            ...
            <p>
              Experience absolute visibility from order placement to final
              invoice.
            </p>
          </div>
          ...
          <div className="workflow-details-grid">
            <div className="feature-card">
              ...
              <p>
                Customize approval matrices and multi-stage verification for
                secure transactions.
              </p>
            </div>
            <div className="feature-card">
              ...
              <h3>AI Analytics</h3>
              <p>
                Leverage predictive algorithms for demand forecasting and
            ...
            <div className="feature-card">
              ...
              <h3>Notifications</h3>
              <p>
                Configure real-time alerts for stockouts, shipping delays, and
                SLA breaches.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                Build custom KPI dashboards and export audit-ready reports
                instantly.
              </p>
            </div>
          </div>
      ...
      <section className="landing-section ai-section" id="ai">
        <div className="global-container">
          <div className="section-header">
            <h2>Driven by AI</h2>
            <p>
              Let intelligent algorithms do the heavy lifting for complex
              logistics planning.
            </p>
          </div>
          <div className="ai-grid">
            <div className="ai-card">
              ...
              <p>
                Predict future material needs based on historical data and
                seasonal trends.
              </p>
            </div>
            <div className="ai-card">
              ...
              <h3>Smart Search</h3>
              <p>
                Find materials, orders, and vendors instantly with natural
                language queries.
              </p>
            </div>
            <div className="ai-card">
              ...
              <p>
                Smart thresholds automatically draft POs before you run out of
                stock.
              </p>
            </div>
            <div className="ai-card">
              ...
              <p>
                Identify slow-moving stock and optimize capital allocation
                effortlessly.
              </p>
            </div>
            <div className="ai-card">
              ...
              <p>
                Automatically flag unusual order volumes or sudden price spikes
                from vendors.
              </p>
            </div>
          </div>
