...
import { Target, Zap, Handshake, IndianRupee, Search, ArrowRight } from "lucide-react";
  ...
  const fetchLeads = async () => {
    try {
      ...
      const augmentedLeads = fetchedData.map((l, idx) => {
        ...
        let stage = "New";
        if (statusLower === "active") stage = "Qualified";else if (statusLower === "contacted") stage = "Contacted";else if (statusLower === "negotiation") stage = "Negotiation";else if (statusLower === "proposal") stage = "Proposal Sent";else if (statusLower === "lead") stage = "New";
        return {
          ...l,
        ...
        duration: 0.4
          ...
          alignItems: "center"
            ...
            flexShrink: 0
              ...
              {writeAccess && <button className="rd-btn-solid" onClick={() => navigate("/crm/add-customer?type=lead")} style={{
              background: "#0ea5e9",
              whiteSpace: "nowrap",
              flexShrink: 0
            }}>
          ...
          <div className="rd-table-scroll">
            ...
            width: "100%"
              ...
              <tbody>
                ...
                return <tr key={l._id || l.id || leadId}>
                        {" "}
                        <td style={{
                    fontWeight: 700,
                    color: "#3b82f6"
