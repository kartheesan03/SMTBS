    ...
    >
      <div className="page-header" style={{ marginBottom: 0 }}>
        <PageHeader
          ...
          badge="FINANCE"
          subtitle="Detailed financial breakdown and historical trends."
        />
      </div>
      {/* KPI ROW */}
      <motion.div
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: "auto" }}>
            ...
            >
              $
              {highestMonth.revenue.toLocaleString(undefined, {
                maximumFractionDigits: 0,
              })}
            </h3>
            <div
      ...
      >
        ...
        >
          ...
          >
            <TrendingUp size={18} color="var(--success)" /> 6-Month Revenue
            Trend
          </h3>
        </div>
        {trendData.length > 0 ? (
          <div
            ...
            style={{ height: "320px", width: "100%", marginLeft: "-24px" }}
          >
