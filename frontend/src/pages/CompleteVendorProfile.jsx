  ...
  return (
    <div className="login-wrapper">
      <div
        ...
        style={{ maxWidth: "800px", width: "90%", margin: "40px auto" }}
      >
        <div
          ...
          >
            ...
            <div className="input-group">
              ...
              <input
                type="text"
                name="category"
                placeholder="Supply Category (e.g., Electronics, Raw Materials)"
            ...
            <div className="input-group">
              ...
              <textarea
                ...
                placeholder="Materials Supplied (comma separated, e.g. Steel, Aluminum)"
