    ...
    const handleGoogleSuccess = async (credentialResponse) => {
        ...
        try {
            ...
            if (credentialResponse.isMock) {
                ...
                response = await API.post('/auth/google', { credential: credentialResponse.credential });
            }
                        ...
                        <div className="google-btn-wrapper">
                            {import.meta.env.VITE_ENABLE_MOCK_GOOGLE === 'true' ? (
                                <button 
                                    ...
                                    onClick={() => handleGoogleSuccess({ isMock: true, email: 'test@mock.com', name: 'Mock Tester' })}
                                >
