          ...
          <div className="ns-toggle-list">
            ...
            <div className="ns-toggle-item">
              ...
              <label className="ns-switch ns-blue">
                <input
                  type="checkbox"
                  checked={prefs.materialMovements}
                  onChange={() => handleToggle("materialMovements")}
                />
                <span className="ns-slider"></span>
              </label>
            </div>
            <div className="ns-toggle-item">
              ...
              <label className="ns-switch ns-purple">
                <input
                  type="checkbox"
                  checked={prefs.hrEvents}
                  onChange={() => handleToggle("hrEvents")}
                />
                <span className="ns-slider"></span>
              </label>
            </div>
            ...
            <div className="ns-toggle-item">
              ...
              <label className="ns-switch ns-indigo">
                <input
                  type="checkbox"
                  checked={prefs.scheduledReports}
                  onChange={() => handleToggle("scheduledReports")}
                />
                <span className="ns-slider"></span>
              </label>
            </div>
      ...
      >
        <div className="ns-footer-left">
          ...
          <div>
            ...
            <p>
              Learn how to configure notifications and stay updated efficiently.
            </p>
          </div>
        </div>
        <button
