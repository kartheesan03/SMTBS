          ...
          <div className="ss-toggle-list">
            ...
            <div className="ss-toggle-item">
              ...
              <label className="ss-switch ss-gray">
                <input
                  type="checkbox"
                  checked={sysPrefs.developerMode}
