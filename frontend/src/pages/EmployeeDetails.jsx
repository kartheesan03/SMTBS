      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <div>
            ...
            <a
              href={`mailto:${
                employee.userId?.email || employee.email || employee.contact
              }`}
              style={{
                color: "#3b82f6",
                textDecoration: "none",
        ...
        <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <div>
            ...
            <a
              href={`tel:${
                employee.phone ||
                (employee.contact && employee.contact.match(/^[0-9+\-\\s]+$/)
                  ? employee.contact
                  : "")
              }`}
              style={{
      ...
      <div className="standard-section">
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: "15px", color: "#0f172a", fontWeight: 500 }}
            >
              {employee.department}
            </div>
          </div>
