          ...
          >
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Automatically email payslips upon disbursement
              </span>
            </div>
        ...
        <div className="settings-card">
          ...
          <div className="settings-form-group" style={{ marginTop: "4px" }}>
            <p style={{ fontSize: "11px", color: "#64748b" }}>
              These percentages act as defaults when creating new employee
              compensation plans, but can be overridden per individual.
            </p>
          </div>
        </div>
        ...
        <div className="settings-card">
          ...
          <div className="toggle-switch-wrapper">
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Deduct PF automatically from gross salary
              </span>
            </div>
            <label className="switch">
              <input
          ...
          {settings.enableProvidentFund && (
            <div
              ...
              style={{ marginTop: "12px", animation: "fadeIn 0.2s" }}
            >
          ...
          >
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Standard monthly deduction for health cover
              </span>
            </div>
            <label className="switch">
              <input
        ...
        <div className="settings-card">
          ...
          <div className="settings-form-group">
            ...
            <p style={{ fontSize: "11px", color: "#64748b", marginTop: "6px" }}>
              If base rate is $20/hr, a 1.5x multiplier results in $30/hr for
              overtime.
            </p>
          </div>
        </div>
