...
const Support = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="support-header-section"
        style={{
          display: "flex",
      ...
      >
        <div className="quick-link-card link-blue">
          <div className="ql-icon-box">
            <BookOpen size={20} />
          </div>
          <h3>Admin Setup Guide</h3>
          <p>
            Step-by-step walkthrough for configuring roles, modules, and
            backups.
          </p>
          <a href="#" onClick={handleGuideClick} className="ql-link">
        ...
        >
          <div className="contact-form-card">
            ...
            <p className="contact-subtitle">
              Can't find what you're looking for? Send our team a message.
            </p>
            <div className="form-group">
              <label>SUBJECT</label>
              <input
                type="text"
                placeholder="e.g. Can't restore a backup"
