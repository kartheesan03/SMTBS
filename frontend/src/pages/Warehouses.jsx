...
const Warehouses = () => {
  ...
  const columns = [{
      ...
      gap: "12px"
        ...
        justifyContent: "center"
          ...
          marginTop: 2
              ...
              {val === "Unassigned" ? "Default Virtual Zone" : "Physical Location"}
            </div>
          </div>
        </div>
  }, {
    ...
    render: (_, row) => <div style={{
      ...
      width: "100%"
          ...
          <button className="rd-btn-compact" onClick={() => setSelectedZone(row)} style={{
        padding: "6px 12px",
        fontSize: 12,
        fontWeight: 600,
        borderRadius: 0,
  ...
  return <div className="rd-container">
      <div className="rd-content">
        ...
        })}`} colorTheme="mint" icon={IndianRupee} trendValue="Across all warehouses" trendPositive={true} />
          <StatsCard title="Total Items Managed" value={summary.items.toLocaleString()} colorTheme="purple" icon={Box} trendValue="Total inventory units" trendPositive={true} />
          <StatsCard title="Critical Alerts" value={summary.lowStock} colorTheme="peach" icon={AlertTriangle} trendValue="Items needing attention" trendPositive={false} />
        </StatsGrid>
        <div style={{
        marginTop: "24px"
      }}>
      ...
      justifyContent: "center"
        ...
        boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04)"
          ...
          justifyContent: "flex-end"
              ...
              <button className="rd-btn-compact" onClick={() => setSelectedZone(null)} style={{
            padding: "8px 16px",
            background: "#fff",
          ...
          padding: "24px"
            ...
            marginBottom: 16
              ...
              marginBottom: 6
                ...
                <input type="text" id="new-wh-name" placeholder="e.g. Facility North" style={{
              width: "100%",
              padding: "10px 12px",
              border: "1px solid #cbd5e1",
              borderRadius: 0,
            ...
            marginBottom: 16
              ...
              marginBottom: 6
                ...
                <input type="text" id="new-wh-loc" placeholder="e.g. 123 Industrial Ave" style={{
              width: "100%",
              padding: "10px 12px",
              border: "1px solid #cbd5e1",
              borderRadius: 0,
