...
const EmployeeScanner = () => {
  ...
  const handleStockAction = async () => {
    ...
    try {
      ...
      toast.success(
        `Successfully ${
          actionType === "inward" ? "added to" : "removed from"
        } stock!`
      );
            ...
            {(scanState === "scanning" ||
              ...
              >
                ...
                {scanState === "not-found" && (
                  ...
                  >
                    <AlertTriangle size={20} /> Barcode not found. Try again or
                    check the SKU.
                  </div>
                )}
                <div
                ...
                >
                  ...
                  >
                    For this demo, type a valid SKU to simulate a successful
                    scan.
                  </p>
                </div>
              </motion.div>
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        {material.category?.name || material.category || "N/A"}
                      </p>
                    </div>
                    <div
                      style={{
                ...
                <div className="ui-card" style={{ padding: "24px" }}>
                      ...
                      style={{
                        ...
                        background:
                          actionType === "inward"
                            ...
                            : "#f8fafc",
                        border: `2px solid ${
                          actionType === "inward" ? "#3b82f6" : "transparent"
                        }`,
                      ...
                      style={{
                        ...
                        background:
                          actionType === "outward"
                            ...
                            : "#f8fafc",
                        border: `2px solid ${
                          actionType === "outward" ? "#f59e0b" : "transparent"
                        }`,
                  ...
                  <button
                    ...
                    style={{
                      ...
                      transition: "all 0.2s",
                      background:
                        actionType === "inward" ? "#3b82f6" : "#f59e0b",
                      boxShadow:
                        actionType === "inward"
                  ...
                  >
                    Confirm {actionType === "inward" ? "Inward" : "Outward"}{" "}
                    Operation
                  </button>
                </div>
              </motion.div>
