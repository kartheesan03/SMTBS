    ...
    return (
        <div className="content-area" style={{ padding: '24px', backgroundColor: '#f8fafc', minHeight: 'calc(100vh - 70px)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                <div>
                    <h1 style={{ fontSize: 24, fontWeight: 700, color: '#0f172a', margin: 0 }}>Projects</h1>
                    <p style={{ color: '#64748b', margin: '4px 0 0 0', fontSize: 14 }}>Manage all active and past projects across departments.</p>
                </div>
                <button onClick={handleCreateProject} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px', backgroundColor: '#3b82f6', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer', fontWeight: 600, fontSize: 14 }}>
