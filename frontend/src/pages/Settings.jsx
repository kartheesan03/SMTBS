...
const Settings = () => {
  ...
  const finalTab =
    !isAdminOrManager &&
    ["Security", "Roles & Permissions", "Integrations"].includes(
      currentTabFromPath
    )
      ? "Profile"
      : currentTabFromPath;
    ...
    const fetchActivity = async () => {
      try {
        const { data } = await API.get(
          `/audit-logs?userId=${user._id}&limit=5`
        );
  ...
  const roleBadge =
    user?.role === "Admin" ? "Super Admin" : user?.role || "Employee";
  const empIdBadge =
    employeeData?.employeeId ||
    employeeData?.employeeCode ||
    (user?.id ? `EMP${user.id.toString().padStart(4, "0")}` : "EMP001");
  ...
  return (
    <div className="page-container">
      ...
      {activeTab === "Roles & Permissions" && isAdminOrManager && (
        <RolesPermissions />
      )}
      {activeTab === "Notifications" && <NotificationSettings />}
      {activeTab === "System" && <SystemSettings />}
      {activeTab === "Integrations" && isAdminOrManager && (
        ...
        <div className="premium-profile-banner">
          ...
          <div className="premium-banner-details">
            ...
            <div className="banner-badges-premium">
              ...
              <span className="premium-badge-banner secondary-badge">
                {empIdBadge}
              </span>
            </div>
            <span className="last-login-banner">
              {displayEmail} &bull; Last Login:{" "}
            ...
            <div className="premium-card h-full" style={{ padding: "24px" }}>
              ...
              <div className="details-list">
                ...
                <div className="detail-row">
                  ...
                  <div className="detail-value">
                    {employeeData?.designation || user?.role || "Staff"}
                  </div>
                </div>
                <div className="detail-row">
