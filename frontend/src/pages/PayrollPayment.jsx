    ...
    return (
      <div style={{ padding: "30px" }}>
        <div style={{ textAlign: "center", padding: "60px 20px" }}>
          ...
          />
          <h2
            style={{ color: "#0f172a", fontSize: "20px", marginBottom: "8px" }}
          >
          ...
          >
            The requested payroll record does not exist or has been deleted.
          </p>
        ...
        >
          ...
          >
            ...
            <p style={{ margin: 0, color: "#047857", fontSize: "14px" }}>
              Salary has been disbursed successfully
            </p>
          </div>
          <div style={{ padding: "28px" }}>
            {[
              ...
              {
                label: "Amount Paid",
                value: `₹${(receipt.netSalary || 0).toLocaleString()}`,
                highlight: true,
              },
              ...
              >
                ...
                <span
                  style={{
                    fontSize: "14px",
                    color: row.highlight ? "#10b981" : "#0f172a",
          ...
          <div
            style={{ padding: "16px 28px 28px", display: "flex", gap: "12px" }}
          >
            <PageHeader title="" showBack={true} backPath="/payroll" />
          </div>
        </div>
    ...
    >
      ...
      <div style={{ marginBottom: "24px" }}>
        <PageHeader
          ...
          badge="HRMS"
          subtitle="Complete payment details and confirm disbursement"
          showBack={true}
          backPath="/payroll"
        />
      </div>
          ...
          <div className="premium-card" style={{ overflow: "hidden" }}>
            ...
            <div style={{ padding: "20px" }}>
              {[
                {
                  label: "Basic Salary",
                  value: `₹${(salary.basicSalary || 0).toLocaleString()}`,
                  color: "#0f172a",
                },
                {
                  label: "Allowances",
                  value: `+₹${(salary.allowances || 0).toLocaleString()}`,
                  color: "#10b981",
                },
                {
                  label: "Deductions",
                  value: `-₹${(salary.deductions || 0).toLocaleString()}`,
                  color: "#ef4444",
                },
              ].map((row, i) => (
                <div
                        ...
                        paymentDetails: {
                          ...
                          chequeDate:
                            m === "Cheque"
                              ...
                              : prev.paymentDetails.chequeDate,
                        },
                      }))
                    }
                    style={{
            ...
            >
              ...
              {form.paymentMethod === "Bank Transfer" && (
                <>
                  ...
                  <FieldRow
                    ...
                    value={form.paymentDetails.transactionReference}
                    onChange={(v) => updateField("transactionReference", v)}
                  />
                </>
              )}
              {form.paymentMethod === "Cheque" && (
                <>
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      value={form.paymentDetails.chequeDate}
                      onChange={(e) =>
                        updateField("chequeDate", e.target.value)
                      }
                      style={{
                        width: "100%",
                        padding: "10px 12px",
              ...
              {form.paymentMethod === "Cash" && (
                <FieldRow
                  icon={<User size={14} />}
                  label="Received By *"
                  placeholder="Person receiving cash"
                  value={form.paymentDetails.receivedBy}
              ...
              {form.paymentMethod !== "Cheque" && (
                <div>
                  ...
                  <input
                    type="date"
                    value={form.paymentDetails.paymentDate}
              ...
              <div>
                ...
                <input
                  ...
                  value={form.paymentDetails.remarks}
