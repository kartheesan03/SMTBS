...
const MyLeaveHistory = () => {
  ...
  const calculateBalances = () => {
    ...
    return {
      Annual: {
        used: used.Annual,
        left: Math.max(0, LIMITS.Annual - used.Annual),
        total: LIMITS.Annual,
        color: "#10b981",
      },
      Sick: {
        used: used.Sick,
        left: Math.max(0, LIMITS.Sick - used.Sick),
        total: LIMITS.Sick,
        color: "#ef4444",
      },
      Casual: {
        used: used.Casual,
        left: Math.max(0, LIMITS.Casual - used.Casual),
        total: LIMITS.Casual,
        color: "#3b82f6",
      },
    };
      ...
      <div className="rd-content">
        ...
        >
          <PageHeader
            ...
            badge="HRMS"
            subtitle="Track your past and pending leave requests"
          />
          <button
