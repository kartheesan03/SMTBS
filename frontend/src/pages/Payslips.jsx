    ...
    >
      <header className="page-header" style={{ marginBottom: 0 }}>
        <PageHeader
          title="Payslips"
          badge="HRMS"
          subtitle="Review employee payment history and download official payslips."
        />
      </header>
        ...
        {history.length === 0 ? (
          ...
          <div className="premium-card" style={{ overflow: "hidden" }}>
            ...
            >
              ...
              >
                <FileText size={18} className="text-primary" /> Employee
                Payslips
              </h3>
              <span
                style={{
              ...
              <div className="payslip-section">
                ...
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <span className="info-value">
                      {selectedPayslip.employee?.employeeId || "N/A"}
                    </span>
                  </div>
                  <div className="info-item">
                    <span className="info-label">Designation</span>
                    <span className="info-value">
                      {selectedPayslip.employee?.designation || "Staff"}
                    </span>
                  </div>
                  <div className="info-item">
              ...
              <div className="payslip-section mt-24">
                ...
                <div className="breakdown-card">
                  ...
                  <div className="row-between mt-12">
                    <span className="breakdown-label text-danger">
                      Taxes & Deductions
                    </span>
                    <span className="breakdown-val negative">
