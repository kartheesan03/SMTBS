...
const SalesPipeline = () => {
  ...
  const funnelData = stageNames.map((stage) => {
    ...
    return {
      ...
      percent:
        Math.round((list.length / totalOrderCount) * 100) ||
        (list.length > 0 ? 10 : 0),
    };
  });
  ...
  if (sourceData.length === 0)
    sourceData.push({ name: "N/A", value: 1, fill: "#94a3b8" });
  const openOrders = orders
    .filter((o) => !["Delivered", "Completed", "Cancelled"].includes(o.status))
    .sort(
      (a, b) =>
        (Number(b.totalAmount) || Number(b.grandTotal) || 0) -
        (Number(a.totalAmount) || Number(a.grandTotal) || 0)
    )
    .slice(0, 4);
          ...
          >
            ...
            {funnelData.map((stage, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center" }}>
                ...
                <div style={{ width: 80, fontSize: 13, color: "#64748b" }}>
                  {stage.count} deals
                </div>{" "}
                <div
                  style={{
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <div>
                  {" "}
                  <h3
                    className="rd-chart-title"
                    style={{ margin: 0, fontSize: 16 }}
                  >
                    Monthly Revenue Trend
                  </h3>{" "}
                  <div style={{ fontSize: 12, color: "#94a3b8" }}>
                    Track your revenue and delivered amount over time
                  </div>{" "}
                </div>{" "}
              </div>{" "}
              <select
            ...
            <div style={{ display: "flex", gap: 16, marginBottom: 24 }}>
              ...
              >
                ...
                >
                  {" "}
                  <span
                    style={{ fontSize: 24, fontWeight: 800, color: "#1e293b" }}
                  >
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 24, fontWeight: 800, color: "#1e293b" }}
                  >
                    {formatShortCurrency(totalDelivered)}
                  </span>{" "}
                  <span
                    style={{ fontSize: 12, fontWeight: 700, color: "#10b981" }}
                  >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, opacity: 0.9, marginTop: 2 }}>
                    {dealCount} active deals worth{" "}
                    {formatShortCurrency(pipelineValue)} in pipeline.{" "}
                    {closedWon} deals closed.
                  </div>{" "}
                </div>{" "}
              </div>{" "}
            </div>{" "}
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "#94a3b8" }}>
                    Analyze customer segments by industry
                  </div>{" "}
                </div>{" "}
              </div>{" "}
              <select
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  {" "}
                  <div style={{ fontWeight: 700, fontSize: 14 }}>
                    Top Segment: {sourceData[0]?.name || "N/A"}
                  </div>{" "}
                  <div style={{ fontSize: 12, opacity: 0.9, marginTop: 2 }}>
                    {sourceData[0]?.value || 0} customers in the{" "}
                    {sourceData[0]?.name || "top"} segment.
                  </div>{" "}
                </div>{" "}
              </div>{" "}
            </div>{" "}
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          Order: {opp.orderNumber || `#${opp._id || opp.id}`}
                        </div>{" "}
                      </div>{" "}
                    </div>{" "}
                    <div
