                ...
                <motion.div variants={itemVariants} className="erp-header-section" style={{ alignItems: 'center', marginBottom: '24px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <span style={{ fontSize: '11px', fontWeight: 700, color: '#475569', background: '#f1f5f9', border: '1px solid #e2e8f0', padding: '4px 8px', borderRadius: '0px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                            INVENTORY
                        </span>
                    </div>
