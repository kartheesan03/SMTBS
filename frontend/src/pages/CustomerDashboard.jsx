...
const CustomerDashboard = () => {
  ...
  if (loading)
    return (
      <LoadingState message="Loading Customer Dashboard..." height="100vh" />
    );
  const getGreeting = () => {
  ...
  const activeDeliveries = orders.filter((o) =>
    ["Shipped", "Processing", "Out for Delivery"].includes(o.deliveryStatus)
  ).length;
  ...
  const displayName =
    profile?.name || profile?.company || user?.name || "Customer";
  return (
    <div
      className="rd-container theme-customer"
      style={{ "--theme-accent": "#ec4899" }}
    >
      <div className="rd-content">
        ...
        <StatsGrid columns={4}>
          ...
          <StatsCard
            ...
            trendPositive={activeDeliveries === 0}
          />
          <StatsCard
          ...
          <StatsCard
            ...
            colorTheme="yellow"
            icon={TrendingUp}
            trendValue="On delivered orders"
            trendPositive={true}
          />
        </StatsGrid>
        {/* ── Main Content ── */}
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr style={{ borderBottom: "1px solid #f1f5f9" }}>
                      {["ORDER ID", "DATE", "AMOUNT", "STATUS", "ACTIONS"].map(
                        (h) => (
                          <th
                            key={h}
                            style={{
                  ...
                  {[
                    {
                      icon: User,
                      label: "Name",
                      value: profile.name || profile.company,
                    },
              ...
              <div className="modal-body">
                  ...
                  <div className="status-info">
                    ...
                    <span
                      style={{
                        ...
                        padding: "3px 10px",
                        borderRadius: 0,
                        background: statusBg(selectedOrder.status),
                ...
                <div className="modal-bottom-cards">
                  ...
                  <div className="info-card">
                    ...
                    <span className="value">
                      {selectedOrder.deliveryStatus || "Not Started"}
                    </span>
                  </div>
                </div>
              </div>
