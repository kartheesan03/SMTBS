  ...
  const fetchVendor = async () => {
    try {
      ...
      setFormData({
        ...
        materialsSupplied: data.materials
          ? data.materials
        ...
        <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
          ...
          <div>
            ...
            <h4 style={{ margin: 0, color: "#1e293b", fontSize: "16px" }}>
              {isEditMode ? formData.name : "New Vendor Profile"}
            </h4>{" "}
            <p
              style={{
                margin: "4px 0 0 0",
      ...
      >
        ...
        <div className="ui-grid-2">
          ...
          <FormSection title="Company Information">
            ...
            <FormGroup label="Outstanding Balance (₹)">
              {" "}
              <Input
                type="number"
                min="0"
          ...
          <FormSection title="Contact Information">
            ...
            <FormGroup label="Website">
              ...
              <Input
                ...
                placeholder={
                  isEditMode ? "" : "e.g. https://www.srilakshmisteel.in"
                }
              />{" "}
            </FormGroup>{" "}
          </FormSection>{" "}
          ...
          <FormGroup label="Address">
            ...
            <Input
              ...
              placeholder={
                isEditMode
                  ? ""
                  : "e.g. SIDCO Industrial Estate, Coimbatore, Tamil Nadu 641021"
              }
            />{" "}
          </FormGroup>{" "}
        </FormSection>{" "}
          ...
          formData.materialsSupplied.length > 0 ? (
            ...
            >
              ...
              <table
                ...
                style={{ whiteSpace: "normal", minWidth: "800px" }}
              >
                {" "}
                <thead>
                  {" "}
                ...
                <tbody>
                  ...
                  {formData.materialsSupplied.map((mat, i) => (
                    <tr key={i}>
                      ...
                      <td>{mat.sku || "-"}</td> <td>{mat.category || "-"}</td>{" "}
                      <td style={{ whiteSpace: "nowrap" }}>
                        {mat.quantity || 0} {mat.unit || "pcs"}
                      </td>{" "}
                      <td style={{ whiteSpace: "nowrap" }}>
                        ₹{mat.price || 0}
                      </td>{" "}
                          ...
                          <button
                            ...
                            onClick={() =>
                              setFormData({
                                ...formData,
                                materialsSupplied:
                                  formData.materialsSupplied.filter(
                                    (_, idx) => idx !== i
                                  ),
                              })
                            }
            ...
            >
              {" "}
              No materials added yet. Click "Add New Material" to link materials
              to this vendor.{" "}
            </div>
          )}{" "}
        </FormSection>{" "}
            ...
            >
              ...
              <div className="ui-grid-2">
                ...
                <FormGroup label="Initial Quantity">
                  ...
                  <Input
                    type="number"
                    value={editingMaterialData.quantity}
                    onChange={(e) =>
                      setEditingMaterialData({
                        ...editingMaterialData,
                ...
                <FormGroup label="Low Stock Threshold">
                  ...
                  <Input
                    type="number"
                    value={editingMaterialData.lowStockThreshold}
                    onChange={(e) =>
                      setEditingMaterialData({
                        ...editingMaterialData,
                ...
                <FormGroup label="Unit Price (₹)">
                  ...
                  <Input
                    type="number"
                    value={editingMaterialData.price}
                    onChange={(e) =>
                      setEditingMaterialData({
                        ...editingMaterialData,
              ...
              <div className="ui-grid-2" style={{ marginTop: "16px" }}>
                ...
                <FormGroup label="Warehouse / Storage Area">
                  {" "}
                  <Input
                    value={editingMaterialData.warehouse}
                    onChange={(e) =>
                      setEditingMaterialData({
                        ...editingMaterialData,
                ...
                <FormGroup label="Shelf / Bin">
                  {" "}
                  <Input
                    value={editingMaterialData.shelf}
                    onChange={(e) =>
                      setEditingMaterialData({
                        ...editingMaterialData,
