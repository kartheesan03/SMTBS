...
const FeedWidgets = () => {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            ...
            {/* Footer Mini-links */}
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', rowGap: '8px', columnGap: '16px', padding: '0 16px', margin: '16px 0 32px 0', color: 'var(--feed-text-muted)', fontSize: '12px', textAlign: 'center' }}>
