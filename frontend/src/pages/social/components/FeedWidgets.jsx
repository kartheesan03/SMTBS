            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', rowGap: '8px', columnGap: '8px', padding: '0 16px', margin: '16px 0 32px 0', color: 'var(--feed-text-muted)', fontSize: '12px', textAlign: 'center', lineHeight: '1.5' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', width: '100%', justifyContent: 'center', marginTop: '8px' }}>
                    <span style={{ color: 'var(--feed-accent-blue)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '4px' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-1.25 0-2 .68-2.34 1.34V9.61h-2.5v8.89h2.5v-4.9a1.76 1.76 0 0 1 1.6-1.9c1 0 1.5.7 1.5 1.9v4.9zM7.22 8.16A1.5 1.5 0 0 0 7.21 5.2a1.5 1.5 0 0 0 0 3zm1.28 10.34V9.61H6v8.89z"/></svg>
                        SMTBMS
                    </span> 
