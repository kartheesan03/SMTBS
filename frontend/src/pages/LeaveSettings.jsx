          ...
          <div className="toggle-switch-wrapper" style={{ marginTop: "16px" }}>
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Allow rolling over unused balances to next year
              </span>
            </div>
        ...
        <div className="settings-card">
          ...
          <div className="settings-form-group">
            ...
            <p style={{ fontSize: "11px", color: "#64748b", marginTop: "6px" }}>
              Minimum days of notice required for Annual Leave requests.
            </p>
          </div>
          <div
          ...
          >
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Require both Manager and HR approval
              </span>
            </div>
            <label className="switch">
              <input
          ...
          >
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Permit Leave Without Pay when balances are exhausted
              </span>
            </div>
            <label className="switch">
              <input
