    ...
    return (
        ...
        >
                                        ...
                                        >
                                            <td className="col-company">
                                                <div className="company-info">
                                                    <div className="avatar-circle">{String(c.company || c.name || 'C')[0]}</div>
            ...
            <style jsx="true">{`
                ...
                .crumb:hover:not(.active) { color: var(--primary); }
                ...
                .header-subtitle { color: var(--text-muted); margin-top: 6px; font-size: 15px; }
                ...
                .search-icon { color: #94a3b8; margin-right: 12px; transition: color 0.3s; }
                .premium-search:focus-within .search-icon { color: var(--primary); }
                .search-input {
                    border: none; background: transparent; outline: none; 
                    width: 100%; color: var(--text-primary); font-size: 14px;
                }
                ...
                .status-badge-inline { padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; white-space: nowrap; }
                .status-badge-inline.approved { background: rgba(21, 128, 61, 0.1); color: #15803d; border: 1px solid rgba(21, 128, 61, 0.2); }
                
                .btn-select-gradient { 
                    background: linear-gradient(135deg, var(--primary) 0%, #1d4ed8 100%); 
                    color: white; border: none; border-radius: 8px; cursor: pointer; 
                    font-weight: 600; white-space: nowrap; padding: 8px 16px;
                    display: inline-flex; align-items: center; gap: 8px;
                    transition: all 0.2s ease; box-shadow: 0 2px 4px rgba(37, 99, 235, 0.2);
                }
                .btn-select-gradient:hover { 
                    transform: translateY(-1px); box-shadow: 0 4px 8px rgba(37, 99, 235, 0.3);
                }
                .btn-select-gradient:active { transform: translateY(1px); }
                
                /* Skeletons */
                .skeleton-loader-container { padding: 0; }
                .skeleton-row { display: flex; padding: 16px 20px; border-bottom: 1px solid var(--border); gap: 20px; }
                .skeleton-cell { height: 20px; background: linear-gradient(90deg, #f1f5f9 25%, #e2e8f0 50%, #f1f5f9 75%); background-size: 200% 100%; animation: shimmer 1.5s infinite; border-radius: 4px; }
                @keyframes shimmer { 0% { background-position: 200% 0; } 100% { background-position: -200% 0; } }
                .w-16 { width: 16%; } .w-13 { width: 13%; } .w-17 { width: 17%; } .w-12 { width: 12%; } .w-22 { width: 22%; } .w-9 { width: 9%; } .w-11 { width: 11%; }
                ...
                .empty-icon-wrapper { width: 80px; height: 80px; border-radius: 50%; background: #f1f5f9; display: flex; align-items: center; justify-content: center; color: #94a3b8; margin-bottom: 16px; }
