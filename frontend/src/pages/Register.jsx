...
import { Shield, Users, Monitor, User, TrendingUp, Eye, EyeOff, Mail, Lock, Zap, Globe, Layers, UserPlus, ArrowRight } from 'lucide-react';
        ...
        <div className="fx-login-shell">
            ...
            <div className="fx-login-nav">
                <div className="fx-nav-left">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fx-nav-icon" style={{ filter: 'drop-shadow(0 0 10px rgba(168, 85, 247, 0.65))' }}>
            ...
            <div className="fx-login-centered">
                <div className="fx-form-card" style={{ padding: '32px' }}>
                    ...
                    <form onSubmit={handleSubmit} className="fx-form" style={{ gap: '14px' }}>
                        {/* Role Selector */}
                        ...
                        {/* Terms */}
                        <div className="fx-remember" onClick={() => setAgreeTerms(!agreeTerms)} style={{ marginTop: '4px' }}>
                            <div className={`fx-checkbox ${agreeTerms ? 'checked' : ''}`} />
                        ...
                        <div className="fx-social-row">
                            <button type="button" className="fx-social-btn" onClick={() => handleGoogleSignup()}>
