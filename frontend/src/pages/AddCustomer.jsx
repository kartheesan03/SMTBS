...
const AddCustomer = ({ isEditMode = false }) => {
  ...
  const isLead = searchParams.get("type") === "lead";
  ...
  return (
    <StandardPageLayout
      ...
      subtitle={
        isEditMode
          ? `Update ${isLead ? "lead" : "customer"} profile information`
          : `Create a new ${isLead ? "lead" : "customer"} profile in the CRM.`
      }
      breadcrumbs={[
        { label: "CRM", path: "/customers" },
        {
          label: isLead ? "Leads" : "Customers",
          path: isLead ? "/crm/leads" : "/customers",
        },
        { label: isEditMode ? "Edit" : "New" },
      ]}
      onSave={handleSubmit}
      onCancel={() => navigate(isLead ? "/crm/leads" : "/customers")}
      ...
      infoCard={
        <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
          ...
          <div>
            ...
            >
              Please provide detailed information for the new{" "}
              {isLead ? "lead" : "customer"} profile.
            </p>
          </div>
        </div>
      }
          ...
          <FormGroup label="Address" required>
            <Input
              ...
              placeholder={
                isEditMode
                  ? ""
                  : "e.g. Race Course Road, Coimbatore, Tamil Nadu 641018"
              }
            />
          </FormGroup>
        </FormSection>
