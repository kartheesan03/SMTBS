...
const ComingSoonPage = ({ title, subtitle }) => {
    return (
        <div className="main-content flex-center" style={{ flexDirection: 'column', gap: '20px', minHeight: '100vh', position: 'relative' }}>
            <div style={{ position: 'absolute', top: '24px', left: '24px', right: '24px' }}>
                <PageHeader title="" showBack={true} />
            </div>
            <div className="premium-card" style={{ padding: '40px', textAlign: 'center', maxWidth: '500px', width: '100%', marginTop: '60px' }}>
