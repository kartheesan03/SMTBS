...
const VendorDashboard = () => {
  ...
  if (loading)
    return (
      <LoadingState message="Loading Vendor Dashboard..." height="100vh" />
    );
  const getGreeting = () => {
  ...
  const totalValue = orders.reduce(
    (s, o) => s + (Number(o.grandTotal) || Number(o.totalAmount) || 0),
    0
  );
  ...
  const maxOrderVal = Math.max(
    ...recentOrders.map(
      (o) => Number(o.grandTotal) || Number(o.totalAmount) || 0
    ),
    1
  );
  ...
  return (
    <div
      className="rd-container theme-vendor"
      style={{ "--theme-accent": "#0ea5e9" }}
    >
      <div className="rd-content">
              ...
              <div className="rd-visual-card">
                ...
                <div
                  ...
                  style={{
                    "--progress":
                      orders.length > 0
                        ? `${Math.round((completedPOs / orders.length) * 100)}%`
                        : "0%",
                  }}
                ></div>
              </div>
        ...
        <StatsGrid columns={4}>
          ...
          <StatsCard
            ...
            colorTheme="peach"
            icon={Store}
            trendValue="Pending fulfillment"
            trendPositive={activePOs === 0}
          />
          <StatsCard
            title="Completed POs"
            value={completedPOs}
            ...
            <div style={{ overflowX: "auto" }}>
              {orders.length === 0 ? (
                <EmptyState
                  ...
                  message="Orders placed with you will appear here."
                />
              ) : (
