      ...
      <div className="settings-grid">
        ...
        <div className="settings-card">
          ...
          <div className="settings-form-group">
            ...
            <p style={{ fontSize: "11px", color: "#64748b", marginTop: "6px" }}>
              Employees arriving this late will be marked as Half-Day.
            </p>
          </div>
        </div>
        {/* Overtime Policies */}
        <div className="settings-card">
          ...
          <div className="settings-form-group">
            ...
            />
            <p style={{ fontSize: "11px", color: "#64748b", marginTop: "6px" }}>
              Hours worked beyond this limit post shift-end will be counted as
              OT.
            </p>
          </div>
        </div>
        ...
        <div className="settings-card">
          ...
          <div className="toggle-switch-wrapper">
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Restrict web check-ins to office networks
              </span>
            </div>
          ...
          >
            <div className="toggle-label-content">
              ...
              <span className="sub-label">
                Require location matching for mobile apps
              </span>
            </div>
            <label className="switch">
              <input
