        ...
        >
          <div>
            ...
            <input
              ...
              value={form.title}
              onChange={handle}
              placeholder="e.g. Advanced Excel & Data Analysis"
              style={inp}
              required
            />
          </div>
      ...
      <div className="rd-content">
        ...
        >
          ...
          <div
            ...
            style={{ borderBottom: "none", flexWrap: "wrap", gap: 12 }}
          >
            <div
              style={{
                display: "flex",
            ...
            >
              <div
                ...
                style={{ minWidth: 240, flexShrink: 0, background: "#fff" }}
              >
                    ...
                    style={{
                      ...
                      border:
                        activeCategory === cat.id
                          ...
                          : "1.5px solid #e2e8f0",
                      background:
                        activeCategory === cat.id ? "#eef2ff" : "#fff",
              ...
              <tbody>
                {loading ? (
                  ...
                  filtered.map((course, i) => {
                    const ss =
                      STATUS_STYLE[course.myStatus] ||
                      STATUS_STYLE["Not Started"];
                    const bs = course.badge
                      ? BADGE_STYLE[course.badge] || {
                          color: "#2563eb",
                          bg: "#eff6ff",
                        }
                      : null;
                      ...
                      <tr key={course.id || i}>
                        ...
                        <td data-label="Action">
                          <button
                            ...
                            disabled={
                              isEnrolling || course.myStatus !== "Not Started"
                            }
                            style={{
                              padding: "6px 12px",
                              borderRadius: 0,
