...
const CustomerNewOrder = () => {
  ...
  const handleItemChange = (index, field, value) => {
    ...
    if (field === "material") {
      const selectedMat = materials.find(
        (m) => String(m.id || m._id) === String(value)
      );
      newItems[index] = {
        ...newItems[index],
        material: value,
  ...
  const addItem = () => {
    setFormData({
      ...
      items: [
        ...formData.items,
        { material: "", quantity: 1, price: 0, name: "" },
      ],
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const invalidItem = formData.items.find(
        (item) => !item.material || item.quantity <= 0
      );
      if (invalidItem) {
        setErrorMessage(
          "Please select a product/material and enter a valid quantity for all rows."
        );
      ...
      const msg =
        err.response?.data?.message || "Error occurred while creating order.";
      setErrorMessage(msg);
    } finally {
      setSubmitLoading(false);
    }
  ...
  return (
    <div className="page-container">
      ...
      <div className="bento-grid">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="options-grid">
              <div className="form-group">
                <label>
                  <Calendar size={14} style={{ marginRight: "6px" }} /> Expected
                  Delivery Date
                </label>
                <input
                  type="date"
              ...
              <div className="form-group full-width">
                <label>
                  <FileText size={14} style={{ marginRight: "6px" }} /> Notes /
                  Requirements
                </label>
                <textarea
                  rows="3"
            ...
            <div className="form-actions">
              ...
              <button
                ...
                disabled={
                  submitLoading || formData.items.some((i) => !i.material)
                }
              >
        ...
        {/* Summary Card (Span 4) */}
        <div
          className="bento-card summary-card"
        ...
        >
            ...
            <div className="summary-row">
              ...
              <strong>
                {formData.items.reduce(
                  (acc, curr) => acc + (curr.material ? curr.quantity : 0),
                  0
                )}
              </strong>
            </div>
          ...
          <div className="info-box">
            <p>
              <strong>Note:</strong> Once submitted, your order status will be
              tracked as "Pending Approval" until sales representatives review
              stock availability.
            </p>
          </div>
        </div>
