...
const NotificationsPage = () => {
  ...
  const handleSeed = async () => {
    try {
      ...
      showToast(
        err.response?.data?.message || "Seed failed (Admin only).",
        false
      );
    } finally {
      setSeeding(false);
      ...
      {displayed.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          {displayed.map((n, index) => {
            const catConfig =
              CATEGORY_CONFIG[n.module] || CATEGORY_CONFIG.system;
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  cursor:
                    n.module === "Orders" || n.link ? "pointer" : "default",
                  position: "relative",
                }}
                onMouseEnter={(e) => {
                    ...
                    {n.status === "unread" && (
                      <span
                        style={{
                          ...
                          flexShrink: 0,
                          boxShadow: `0 0 6px ${typeStyle.color}40`,
                          marginLeft: "auto",
                        }}
                      ></span>
                    )}
