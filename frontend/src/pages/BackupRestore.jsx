...
const BackupKPICard = ({
  ...
  return (
    <div className={`ent-module-card ${themeClass}`}>
      ...
      <div className="ent-card-title" title={title}>
        {title}
      </div>
...
const BackupRestore = () => {
  ...
  const handleRestore = async (id) => {
    if (
      window.confirm(
        "WARNING: Restoring this backup will overwrite all current live data. This action cannot be undone. Are you sure you want to proceed?"
      )
    ) {
  ...
  return (
    <div className="backup-restore-container">
      {/* Header */}
      <div
        className="backup-header-section"
        style={{
          display: "flex",
      ...
      >
        <PageHeader
          ...
          badge="SYSTEM"
          subtitle="Protect your data with scheduled backups and one-click restores."
        />
        <div className="backup-header-actions">
          <button
            className="btn-download-latest"
                      ...
                      <tr key={item._id || index}>
                        ...
                        <td className="td-actions">
                          ...
                          >
                            <button
                              onClick={() =>
                                handleDownload(item._id, item.backupName)
                              }
                              title="Download"
                              style={{
                                width: "32px",
        ...
        <div className="backup-sidebar">
          ...
          <div className="backup-warning-card">
            ...
            <div className="warning-content">
              ...
              <p>
                Always create a fresh manual backup before restoring an older
                snapshot, in case you need to undo the restore.
              </p>
            </div>
          </div>
        </div>
