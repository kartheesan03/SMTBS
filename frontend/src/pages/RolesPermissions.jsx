...
const RolesPermissions = () => {
  ...
  const handleEditRole = async (e) => {
    ...
    try {
      setSubmitting(true);
      await API.put(`/roles/${editingRole._id || editingRole.id}`, {
        name: editRoleName,
        description: "",
    ...
    <div className="rp-container">
      ...
      >
        <PageHeader
          ...
          badge="SYSTEM"
          subtitle="Manage system access levels and module permissions for different user roles."
        />
      ...
      <div className="rp-bottom-info">
        <div className="rp-info-banner">
          ...
          <p>
            Logged in as: <strong>Admin</strong>. You have full access to modify
            roles.
          </p>
        </div>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ marginTop: 8, display: "flex", gap: 8 }}>
                  <input
                    ...
                    placeholder="Type custom permission..."
                    style={{
                      flex: 1,
                      padding: "6px 10px",
                      border: "1px solid #cbd5e1",
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (p && !newRolePerms.includes(p)) {
                        setNewRolePerms([...newRolePerms, p]);
                        if (!availablePermissions.includes(p))
                          setAvailablePermissions([...availablePermissions, p]);
                      }
                      setCustomPerm("");
                    }}
                    style={{
      ...
      {viewingRole && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ margin: 0, fontSize: 18, color: "#0f172a" }}>
                Access Overview: {viewingRole.name}
              </h3>
              <button
            ...
            <div style={{ padding: 24, maxHeight: "60vh", overflowY: "auto" }}>
              ...
              <h4
                style={{ margin: "0 0 12px 0", fontSize: 14, color: "#0f172a" }}
              >
