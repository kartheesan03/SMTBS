...
const regex = /<div className="db-page">[\s\S]*?(?=\n\s*\);\n};)/;
const replacement = `<div className="db-page">
      <div className="db-content">
        ...
        <div className="db-greeting-bar" style={{display:"flex", justifyContent:"space-between", marginBottom: 24}}>
          <div className="db-greeting-left">
            <div className="db-greeting-text" style={{fontSize: 24, fontWeight: 800, color:"#111827"}}>Good Morning, {user?.name?.split(" ")[0] || "Admin"}! 👋</div>
          ...
          <div className="db-greeting-right" style={{display:"flex", alignItems:"center", gap: 24}}>
            ...
            <div className="db-status-pill" style={{background:"#dcfce7", color:"#16a34a", padding:"6px 12px", borderRadius:20, fontSize:12, fontWeight:600, display:"flex", alignItems:"center", gap:6}}><div style={{width:6, height:6, borderRadius:"50%", background:"#16a34a"}} />All Systems Operational</div>
          </div>
        </div>
