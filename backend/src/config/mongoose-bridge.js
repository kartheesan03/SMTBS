...
function wrapInstance(instance, modelName) {
    ...
    const proxy = new Proxy(instance, {
        get(target, prop, receiver) {
            ...
            if (prop === 'customer' && (modelName === 'Order' || modelName === 'Ticket' || modelName === 'Quotation')) {
...
class MongooseQuery {
    ...
    populate(path, select) {
        ...
        paths.forEach(p => {
            ...
            if (pathName === 'customer' && (this.modelName === 'Order' || this.modelName === 'Ticket' || this.modelName === 'Quotation')) {
                const customerModels = this.modelName === 'Quotation' ? ['Customer'] : ['Customer', 'Lead'];
                customerModels.forEach(modelKey => {
